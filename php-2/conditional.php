...
echo reverseString("Rachmat Setiawan");
echo "<br>";
...
// Code function di sini
function palindrome($cekPalindrome){
    $balik = reverseString($cekPalindrome);
    if ($cekPalindrome === $balik){
        echo "$cekPalindrome => true<br>";
    }else {
        echo "$cekPalindrome => false<br>";
    }
}
// Hapus komentar di bawah ini untuk jalankan code
